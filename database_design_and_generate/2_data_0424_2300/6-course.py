...
# 保存到CSV
course_df.to_csv('course.csv', index=False)

# 预览数据
print("Generated Courses Sample:")
print(course_df[['course_id', 'name', 'start_date', 'end_date', 'start_time', 'end_time', 'hours', 'coach_id', 'branch_id', 'location', 'fee', 'requirement', 'max_seats', 'img']].head(3).to_string(index=False))